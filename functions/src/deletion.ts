...
async function deidentifyAuthoredReadingLog(
  ...
  await log.ref.update({
    ...
    comprehensionAudioUploadedAt: admin.firestore.FieldValue.delete(),
    comprehensionAudioObjectGeneration: admin.firestore.FieldValue.delete(),
    comprehensionAudioReviewStatus: admin.firestore.FieldValue.delete(),
    comprehensionAudioReviewedAt: admin.firestore.FieldValue.delete(),
    comprehensionAudioReviewedGeneration: admin.firestore.FieldValue.delete(),
