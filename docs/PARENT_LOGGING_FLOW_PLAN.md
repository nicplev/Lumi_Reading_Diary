...
**Status:** IMPLEMENTED v3 — all phases merged 2026-07-24 (Phase 1 PRs A–G, Phase 2 batches 1–3, Phase 3 analytics; remaining Phase-3 items deliberately deferred with rationale). **PENDING: prod deploys (rules + functions, Nic confirm) · app release · Nic's parentBackdating portal toggle.**
**Date:** 2026-07-24
