...
- **Current item:** finish P1-3 with a release-device network capture and live App Store/Play questionnaire updates, then P1-7 live credential restrictions/rotation and the remaining external/on-device controls; P0-1/P0-5 still need live App Check/IAM/on-device evidence and the full media-decoder decision.
