...
| HR1/HR2/HR3 | Screening / training / offboarding | Not Ready | [NIC]+[DOC] | ◐ HR pack + training-record template drafted; **Nic holds WWCC (HR1 met — record details)**; need dated training + populated register | 0.1 / 4 |
| GO1/GO2 | Named security & privacy officers | Not Ready | [NIC]+[DOC] | ◐ appointment letters drafted (sign-and-date) | 0.3 |
...
| 2026-07-24 | **Sign-and-fill artifacts drafted** (evidence pack now 19 docs, `325b94b`): GO1 Security-Lead + GO2 Privacy-Officer appointment letters, restore-drill record (D3), security-training record (HR2). **Nic confirmed he holds a current WWCC** → HR1 met in substance (record the details in the restricted HR file). |
